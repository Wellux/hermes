...
def get_env_value(name: str, default=None):
    ...
    Resolve hermes_cli.config.get_env_value at call time so full-suite tests
    that reload or monkeypatch hermes_cli.config do not leave xAI HTTP helpers
    pinned to a stale function object.
    """
    try:
